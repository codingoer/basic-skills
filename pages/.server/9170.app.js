...
const data = {
  "key": "v-001e2432",
  "path": "/java/collection/list/list.html",
  "title": "List",
  "lang": "zh-CN",
  "frontmatter": {},
  "excerpt": "",
  ...
  "filePathRelative": "java/collection/list/list.md",
  "git": {
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ list_html)
});

;// CONCATENATED MODULE: ./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/@vuepress/bundler-webpack/lib/build/ssr/vuepressLoader.js!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[1]!./.temp/pages/java/collection/list/list.html.vue?vue&type=template&id=187d2583

function ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<!--[--><h1 id="list" tabindex="-1"><a class="header-anchor" href="#list" aria-hidden="true">#</a> List</h1><h2 id="sort方法" tabindex="-1"><a class="header-anchor" href="#sort方法" aria-hidden="true">#</a> sort方法</h2><div class="language-java ext-java line-numbers-mode"><pre class="language-java"><code>    <span class="token keyword">default</span> <span class="token keyword">void</span> <span class="token function">sort</span><span class="token punctuation">(</span><span class="token class-name">Comparator</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token operator">?</span> <span class="token keyword">super</span> <span class="token class-name">E</span><span class="token punctuation">&gt;</span></span> c<span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
;// CONCATENATED MODULE: ./.temp/pages/java/collection/list/list.html.vue
...
;
//# sourceMappingURL=9170.app.js.map